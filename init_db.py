...
def main():
    ...
    statements = [
        ...
        ('Horizon Zero Dawn', '2017-02-28', 'Experience Aloy''s legendary quest to unravel the mysteries of a future Earth.', 10, 4, 'https://upload.wikimedia.org/wikipedia/en/a/ae/Horizon_Zero_Dawn.jpg'),
        ('Bloodborne', '2015-03-24', 'A fast-paced action RPG set in the ancient city of Yharnam.', 4, 4, 'https://upload.wikimedia.org/wikipedia/en/6/6d/Bloodborne_Cover_Art.jpg'),
